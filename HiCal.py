...
# Write a solution that's efficient even when we can't put a 
# nice upper bound on the numbers representing our time ranges. 
...
def merge_ranges():
    """Take a list of multiple meeting time ranges and return a list of condensed ranges.
